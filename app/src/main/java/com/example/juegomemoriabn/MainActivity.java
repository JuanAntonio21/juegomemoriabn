package com.example.juegomemoriabn;
...
public class MainActivity extends AppCompatActivity {
    int personajes[] = {R.drawable.gavi,
            R.drawable.messi,R.drawable.neymar,
            R.drawable.pedri,R.drawable.cristiano,
            R.drawable.suarez};
    ...
    public void iniciar() {
        ...
        img1.setImageResource(R.drawable.reverso);
        img2.setImageResource(R.drawable.reverso);
        img3.setImageResource(R.drawable.reverso);
        img4.setImageResource(R.drawable.reverso);
        img5.setImageResource(R.drawable.reverso);
        img6.setImageResource(R.drawable.reverso);
        img7.setImageResource(R.drawable.reverso);
        img8.setImageResource(R.drawable.reverso);
        img9.setImageResource(R.drawable.reverso);
        img10.setImageResource(R.drawable.reverso);
        img11.setImageResource(R.drawable.reverso);
        img12.setImageResource(R.drawable.reverso);
    ...
    private void controlador(int i, final ImageView img) {
        ...
        bmp=null;
        switch (i) {
            case 0: bmp=BitmapFactory.decodeResource(getResources(), R.drawable.gavi);break;
            case 1: bmp=BitmapFactory.decodeResource(getResources(), R.drawable.messi);break;
            case 2: bmp=BitmapFactory.decodeResource(getResources(), R.drawable.neymar);break;
            case 3: bmp=BitmapFactory.decodeResource(getResources(), R.drawable.pedri);break;
            case 4: bmp=BitmapFactory.decodeResource(getResources(), R.drawable.cristiano);break;
            case 5: bmp=BitmapFactory.decodeResource(getResources(), R.drawable.suarez);break;
        }
            ...
            if (control==i) {//si es que han marcado por segunda vez y preguntamos si son iguales
                ...
                new CountDownTimer(2000,1000) {
                    ...
                    public void onFinish() {
                        p.setImageResource(R.drawable.reverso);
